  ...
  return (
    <div className="max-w-[100rem] mx-auto p-6 bg-white rounded-xl shadow-lg">
      ...
      {completed ? (
        ...
        >
          <LucideCheck size={64} className="text-green-600 mx-auto mb-4" />
            ...
            {completed ? (
              ...
              <div className="flex items-center space-x-4">
                <Button
                  ...
                  className="rounded-full border-2 border-green-500 bg-white text-black px-6 disabled:opacity-50
                ...
                <Button
                  onClick={handleNext}
                  className="rounded-full bg-green-500 text-white px-6 hover:bg-green-600 transition-all"
                >
